...
import com.redsponge.extron.plus.inventory.InventoryUtils;
import com.redsponge.extron.plus.utils.ParticleEffect;
...
public class JetpackHandler {
    ...
    public JetpackHandler() {
        ...
        ExtronPlus.INSTANCE.getLogger().info("Started jetpack task, it will now repeat every tick!");
    }
