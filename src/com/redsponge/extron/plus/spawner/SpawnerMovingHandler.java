package com.redsponge.extron.plus.spawner;

import com.redsponge.extron.plus.ExtronPlus;
import com.redsponge.extron.plus.event.custom.BlockPistonPoweredByRedstoneBlockEvent;
...
public class SpawnerMovingHandler implements Listener {
    ...
    public SpawnerMovingHandler() {
        ...
        Bukkit.getScheduler().scheduleSyncRepeatingTask(ExtronPlus.INSTANCE, () -> tickSpawnerMinecarts(), 0, 1);
    }
